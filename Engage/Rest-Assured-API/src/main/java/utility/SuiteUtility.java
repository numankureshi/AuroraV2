...
public class SuiteUtility {
	...
	public static boolean WriteResultUtility2(Read_XLS xls, String sheetName, String colName, HashMap<String, String> statusCode) {
		return xls.writeResultPerformance(sheetName, colName, statusCode);
	}
}
