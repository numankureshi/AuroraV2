package com.sogo.performance.rmx;
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getFreqTableReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getConditionalReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.get2LvlCrossTabReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.get3LvlCrossTabReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getPivotReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getVerbatimReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getAssessmentSummaryReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getResponseTrendReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getStatisticalReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getStatisticalReportReadingWithSegmentAnswserOption(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getStatisticalReportReadingWithMoreThanOneSegQue(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getEngagementReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getComparisonReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getBallotBoxReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getAdvPivotReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getSegmentationReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getResponseRateReportReading(getDriver(), param, test);
				System.out.println(readingData);
...
//				password = decryptPass.decryptUserPassword(encPassword);
				...
				staticPage.login(getDriver(), param, username, encPassword, URLs.get(key), test);
				rmxPage.goToReportPage(getDriver(), param, surveyTitle, SID, test);
				readingData = rmxPage.getAdvFreqRReportReading(getDriver(), param, test);
				System.out.println(readingData);
