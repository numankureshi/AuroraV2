...
public class XLSDataProvider {
	...
	public static Object[][] sanityTestData(Method m) {
		...
		Object[][] dataSet = fetchExcelDataSet.getDataSetAsObjectArray(System.getProperty("user.dir") + "\\src\\main\\resources\\excelfiles\\Engage_Performance.xlsx", "PerformanceTC", m.getName());
		return dataSet;
	}
}
