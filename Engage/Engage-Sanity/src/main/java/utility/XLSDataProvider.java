...
public class XLSDataProvider {
	...
	public static Object[][] sanityTestData(Method m) {
		...
		Object[][] dataSet = fetchExcelDataSet.getDataSetAsObjectArray(System.getProperty("user.dir") + "\\src\\main\\resources\\excelfiles\\Engage_Sanity.xlsx", "SanityTC", m.getName());
		return dataSet;
	}
}
