...
public class RMXPage_TC extends SuiteBase {
	...
	public void Sanity_TC10(LinkedHashMap<String, String> data) throws Exception {
		...
		rmxPage.loadDARReport(getDriver(), param, getData(data, "surveyname"), getData(data, "surveyid"), test);
	}
}
	...
	public void Sanity_TC9(LinkedHashMap<String, String> data) throws Exception {
		...
		rmxPage.loadEngagementReport(getDriver(), param, "Dimensional Report 1" , "91", test);
	}
}
