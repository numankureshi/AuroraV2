package com.research.smoke.surveypage;
...
public class SurveyPage_TC extends SuiteBase {
	...
	public void Smoke_TC1(LinkedHashMap<String, String> data) throws Exception {
		...
		if (CaseToRun.equalsIgnoreCase("N")) {
			...
			for (String key : participationURLs.keySet()) {
				...
				loadBrowser();
				sp.checkSurveyForm(getDriver(), param, test);
			}
		}
...
//			String path = captureScreenShot(Result, "PASS", getDriver());
	...
	public void afterSuite() {
			...
			extent.flush();
			fetchExcelData.reportLog("Research_Smoke", "Report", "xlsx");
