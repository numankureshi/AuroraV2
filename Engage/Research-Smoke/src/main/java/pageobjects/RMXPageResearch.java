...
import property.IRMXPageResearch;
import utility.SeleniumUtils;

public class RMXPageResearch extends SeleniumUtils implements IRMXPageResearch, IRMXPage{
	...
	public void generateAdvancedFrequencyReport(WebDriver driver, HashMap<String, String> param, ExtentTest test) throws InterruptedException{
		...
		RMXPage rmxPage = new RMXPage();
		rmxPage.goToReportsPage(driver, param, test);
		rmxPage.selectFrequencyReport(driver, param, test);
		rmxPage.selectAllQuestions(driver, param, test);
		reorderQuestions(driver, param, test);
		rmxPage.propertiesPage(driver, param, test);
	...
	public void reorderQuestions(WebDriver driver, HashMap<String, String> param, ExtentTest test) throws InterruptedException{
		...
		action.clickAndHold(driver.findElement(By.xpath("//div[@id='dv3']"))).moveToElement(driver.findElement(By.xpath("//div[@id='dv2']"))).release(driver.findElement(By.xpath("//div[@id='dv3']"))).build().perform();
		Thread.sleep(2000);
