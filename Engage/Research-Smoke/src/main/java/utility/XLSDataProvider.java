...
public class XLSDataProvider {
	...
	public static Object[][] sanityTestData(Method m) {
		...
		Object[][] dataSet = fetchExcelDataSet.getDataSetAsObjectArray(System.getProperty("user.dir") + "\\src\\main\\resources\\excelfiles\\Research_Smoke.xlsx", "SmokeTC", m.getName());
		return dataSet;
	}
}
